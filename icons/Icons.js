...
export function MapIcon(width, height, fill) {
  return (
    <Svg
      width={width}
      height={height}
    ...
    >
      <Path
        d="M6.775 12.99a4.633 4.633 0 004.968.971 4.576 4.576 0 001.482-.972c.426-.417.764-.913.996-1.46.231-.548.35-1.135.35-1.729 0-1.2-.486-2.347-1.346-3.19A4.609 4.609 0 0010 5.3c-1.206 0-2.367.47-3.225 1.31A4.465 4.465 0 005.429 9.8c0 1.2.486 2.347 1.346 3.19zM10 26.49a64.19 64.19 0 01-4.176-5.4c-1.231-1.788-2.447-3.782-3.352-5.761C1.561 13.335 1 11.43 1 9.8c0-2.327.943-4.563 2.629-6.215A9.104 9.104 0 0110 1c2.393 0 4.685.932 6.371 2.585A8.702 8.702 0 0119 9.8c0 1.631-.56 3.535-1.472 5.529-.905 1.98-2.12 3.973-3.352 5.76A64.178 64.178 0 0110 26.49z"
        fill = {fill}
      />
    </Svg>
  )
