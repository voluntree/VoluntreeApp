...
const ActivityScreen = () => {
  ...
  const BotonDonar = () => {
    return (
      <TouchableOpacity className="bg-costas justify-center items-center rounded-md px-4 py-2" onPress={abrirDonacion}>
        <Text className="text-ambiental text-sm">Donación</Text>
      </TouchableOpacity>
    );
  };
  ...
  return (
    <SafeAreaView>
      <ScrollView className="flex bg-blanco h-full w-full px-2 space-y-2 pb-5">
        ...
        <View className="flex flex-row items-center justify-center h-fit">
          <BotonParticipa />
        </View>
        <View className="flex flex-row items-center justify-center h-fit">
          <BotonDonar />
